  ...
  function EstadisticasListController($filter, EstadisticasService, AlarmsService, LogsService, UsersService, Authentication, NetworksService, SolicitudsService) {
    ...
    function generateLogPeriodPdf() {
      ...
      <body class="landing-page">
       <br/>
       <img src="/modules/core/client/img/brand/logo.png" width="200" alt="Geoatencion">
       <div>
          <h2>${removeDiacritics(vm.date)}</h2>
       </div>
       <br/>
          <table>
            <thead>
      ...
      vm.logPeriod.forEach(function (data) {
        ...
        <tr>
          ...
          <td style="padding-right: 35%; text-align: justify;">${removeDiacritics(data.description)}</td>
        </tr>
        `;
      });
      var footer = '</tbody> </table> <footer class="footer"> <div class="container"> <div class="copyright pull-right"> Unetenos y mantente al tanto...El equipo de Geotencion, siempre para usted.&copy; 2017</div></div></footer></body></html>';
